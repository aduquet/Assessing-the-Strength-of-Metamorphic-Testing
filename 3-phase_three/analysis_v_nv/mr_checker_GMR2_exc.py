    ...
    def main(dir, root_path_td, root_path_ttd, output):
                ...
                try:
                    ...
                    final_file = {
                        key:{
                            ...
                            'vs_gmr_exc_g': vs_mrg_exc_g,
                            'vs_gmr_exc_l': vs_mrg_exc_l,
                            'vs_gmr_exc_e': vs_mrg_exc_e,
                        }
                    }
                    ...
                    final_file = {
                        key:{
                            ...
                            'td_x': td[key]['input_xdat'],
                            'td_y': td[key]['input_ydat'],
                            'ttd_x': all_td_ttd[key]['ttd_xdat_MRG2_exc'],
                            'ttd_y': all_td_ttd[key]['ttd_ydat_MRG2_exc'],
                            'td_output_x': td[key]['output_xdat'],
                            'td_output_y': td[key]['output_ydat'],
                            'ttd_output_x' : 'NA',
                            'ttd_output_y' : 'NA',
        ...
        if(dir == 'y'):
            ...
            for root_path in paths:
                ...
                root_path_ttd_final = os.path.join(new_root_path_ttd, 'Results_MRG2_exc_' + name_folder +'.json')
