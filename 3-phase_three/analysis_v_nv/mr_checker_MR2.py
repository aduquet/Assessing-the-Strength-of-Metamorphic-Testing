    ...
    def main(dir, root_path_td, root_path_ttd, output):
        ...
        if(dir == 'n'):
            ...
            for key, value in td.items():
                ...
                try:
                    ...
                    vs_mr2 =Checker_MRG.mr_mul_equal(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    final_file = {
                        key:{
                            'id': key,
        ...
        if(dir == 'y'):
            ...
            for root_path in paths:
                ...
                root_path_ttd_final = os.path.join(new_root_path_ttd, 'Results_MR2_v2_' + name_folder +'.json')
