    ...
    def main(dir, root_path_td, root_path_ttd, output):
        ...
        if(dir == 'n'):
            ...
            for key, value in td.items():
                ...
                try:                
                    vs_mrg_ref = Checker_MRG.mr_ref_eq(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    # vs_mrg_inv_l =Checker_MRG.mr_ref_eq(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    # vs_mrg_inv_e =Checker_MRG.mr_ref_eq(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    final_file = {
                        key:{
                            'id': key,
                            ...
                            'vs_gmr_ref': vs_mrg_ref,
                            # 'vs_gmr_ref_l': vs_mrg_ref,
                            # 'vs_gmr_ref_e': vs_mrg_ref,
                        }
                    }
        ...
        if(dir == 'y'):
            ...
            for root_path in paths:
                ...
                root_path_ttd_final = os.path.join(new_root_path_ttd, 'Results_MRG5_reflection_' + name_folder +'.json')
