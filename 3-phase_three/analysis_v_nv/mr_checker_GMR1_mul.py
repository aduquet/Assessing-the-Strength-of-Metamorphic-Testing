...
python3 mr_checker.py -n n -i '/Users/alduck/Documents/Github/mt_industrial_usecase/SpecialIssue_PROFES/MutationAnalisys/Analysis/unmutated_new/Results_new_unmutated.json' -t '/Users/alduck/Documents/Github/mt_industrial_usecase/SpecialIssue_PROFES/MutationAnalisys/Analysis/unmutated_new/Results_MRG1_mul_unmutated.json' -o 'gmr_mul_unmutated'
    ...
    def main(dir, root_path_td, root_path_ttd, output):
        ...
        if(dir == 'n'):
            ...
            for key, value in td.items():
                ...
                try:
                    ...
                    const = all_td_ttd[key]['const']
                    
                    vs_mrg_mul_scaled_vs = Checker_MRG.mr_mul_scaled(td_int_x,td_int_y,ttd_int_x, ttd_int_y, const)
                    vs_mrg_mul_g = Checker_MRG.mr_mul_g(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    vs_mrg_mul_l =Checker_MRG.mr_mul_l(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    vs_mrg_mul_e =Checker_MRG.mr_mul_equal(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    final_file = {
                        key:{
                            'id': key,
                            ...
                            'ttd_int_x' : ttd[key]['int_x'],
                            'ttd_int_y': ttd[key]['int_y'],
                            'vs_gmr_mul_scaled': vs_mrg_mul_scaled_vs,
                            'vs_gmr_mul_g': vs_mrg_mul_g,
                            'vs_gmr_mul_l': vs_mrg_mul_l,
                            'vs_gmr_mul_e': vs_mrg_mul_e,
                        }
                    }
        ...
        if(dir == 'y'):
            ...
            for root_path in paths:
                ...
                root_path_ttd_final = os.path.join(new_root_path_ttd, 'Results_MRG1_mul_' + name_folder +'.json')
