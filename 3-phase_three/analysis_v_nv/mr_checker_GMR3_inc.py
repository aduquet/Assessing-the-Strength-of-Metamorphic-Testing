...
python3 mr_checker.py -n n -i '/Users/alduck/Documents/Github/mt_industrial_usecase/SpecialIssue_PROFES/MutationAnalisys/Analysis/unmutated_new/Results_new_unmutated.json' -t '/Users/alduck/Documents/Github/mt_industrial_usecase/SpecialIssue_PROFES/MutationAnalisys/Analysis/unmutated_new/Results_MRG1_exc_unmutated.json' -o 'gmr_exc_unmutated'
    ...
    def main(dir, root_path_td, root_path_ttd, output):
        ...
        if(dir == 'n'):
            ...
            for key, value in td.items():
                ...
                try:
                    vs_mrg_exc_g = Checker_MRG.mr_exc_g(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    vs_mrg_exc_l =Checker_MRG.mr_exc_l(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    vs_mrg_exc_e =Checker_MRG.mr_exc_equal(td[key]['int_x'],td[key]['int_y'],ttd[key]['int_x'],ttd[key]['int_y'])
                    final_file = {
                        key:{
                            'id': key,
                            ...
                            'vs_gmr_inc_g': vs_mrg_exc_g,
                            'vs_gmr_inc_l': vs_mrg_exc_l,
                            'vs_gmr_inc_e': vs_mrg_exc_e,
                        }
                    }
                    ...
                    final_file = {
                        key:{
                            ...
                            'td_x': td[key]['input_xdat'],
                            'td_y': td[key]['input_ydat'],
                            'ttd_x': all_td_ttd[key]['ttd_xdat_MRG3_inc'],
                            'ttd_y': all_td_ttd[key]['ttd_ydat_MRG3_inc'],
                            'td_output_x': td[key]['output_xdat'],
                            'td_output_y': td[key]['output_ydat'],
                            'ttd_output_x' : 'NA',
                            'ttd_output_y' : 'NA',
        ...
        if(dir == 'y'):
            ...
            for root_path in paths:
                ...
                root_path_ttd_final = os.path.join(new_root_path_ttd, 'Results_MRG3_inc_' + name_folder +'.json')
